...
export function GamePage() {
  ...
  const saveRoundResult = useMutation({
    mutationFn: async (nextBalance: number) => {
      ...
      // increment games_played via update + current value (simple approach)
  ...
  const canSplitNow =
    actions.canSplit && round.stage === 'player_turn' && player.balance - totalBet >= bet
            ...
            <section className="rounded-2xl border border-gold/20 bg-black/40 p-4">
              ...
              <div className="mt-4 grid gap-4 md:grid-cols-2">
                ...
                {round.hands.map((h, idx) => {
                  ...
                  const active =
                    round.stage === 'player_turn' && idx === round.activeHandIndex
              ...
              <div className="mt-4 grid grid-cols-3 gap-3">
                ...
                <button
                  ...
                  title={
                    canSplitNow
                      ? 'Split'
                      : 'Need a matching pair + enough chips'
                  }
                >
                  Split
                </button>
